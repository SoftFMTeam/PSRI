...
#include <log4cxx/pattern/patternparser.hpp>
#include <log4cxx/pattern/loggingeventpatternconverter.hpp>
#include <log4cxx/pattern/formattinginfo.hpp>
#include <log4cxx/helpers/stringhelper.hpp>
#include <log4cxx/helpers/pool.hpp>
#include <log4cxx/helpers/optionconverter.hpp>

#include <log4cxx/pattern/loggerpatternconverter.hpp>
#include <log4cxx/pattern/colorendpatternconverter.hpp>
#include <log4cxx/pattern/colorstartpatternconverter.hpp>
#include <log4cxx/pattern/shortfilelocationpatternconverter.hpp>
#include <log4cxx/pattern/literalpatternconverter.hpp>
#include <log4cxx/helpers/loglog.hpp>
#include <log4cxx/pattern/classnamepatternconverter.hpp>
...
#include <log4cxx/pattern/fulllocationpatternconverter.hpp>
#include <log4cxx/pattern/integerpatternconverter.hpp>
#include <log4cxx/pattern/linelocationpatternconverter.hpp>
#include <log4cxx/pattern/messagepatternconverter.hpp>
#include <log4cxx/pattern/lineseparatorpatternconverter.hpp>
#include <log4cxx/pattern/methodlocationpatternconverter.hpp>
#include <log4cxx/pattern/levelpatternconverter.hpp>
#include <log4cxx/pattern/relativetimepatternconverter.hpp>
#include <log4cxx/pattern/threadpatternconverter.hpp>
#include <log4cxx/pattern/mdcpatternconverter.hpp>
#include <log4cxx/pattern/ndcpatternconverter.hpp>
#include <log4cxx/pattern/propertiespatternconverter.hpp>
#include <log4cxx/pattern/throwableinformationpatternconverter.hpp>
