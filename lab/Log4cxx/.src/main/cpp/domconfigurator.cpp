 ...
 */
#include <log4cxx/private/string_c11.hpp>
...
#include <log4cxx/config/propertysetter.hpp>
#include <log4cxx/spi/errorhandler.hpp>
#include <log4cxx/spi/loggerfactory.hpp>
#include <log4cxx/defaultloggerfactory.hpp>
#include <log4cxx/helpers/filewatchdog.hpp>
...
#include <apr_xml.hpp>
#include <log4cxx/helpers/bytebuffer.hpp>
#include <log4cxx/helpers/charsetdecoder.hpp>
#include <log4cxx/net/smtpappender.hpp>
#include <log4cxx/helpers/messagebuffer.hpp>
#include <log4cxx/helpers/threadutility.hpp>

#define LOG4CXX 1
#include <log4cxx/helpers/aprinitializer.hpp>
