...
#ifdef HAVE_CANN
#include "acl/acl.hpp" // acl* functions
#include "graph/graph.hpp" // ge::Graph; ge::Operator from operator.h
#include "graph/ge_error_codes.hpp" // GRAPH_SUCCESS, ...

#ifdef CANN_VERSION_BELOW_6_3_ALPHA002
    #include "op_proto/built-in/inc/all_ops.hpp" // ge::Conv2D, ...
#else
    #include "built-in/op_proto/inc/all_ops.hpp" // ge::Conv2D, ...
#endif
#include "graph/tensor.hpp" // ge::Shape, ge::Tensor, ge::TensorDesc
#include "graph/types.hpp" // DT_FLOAT, ... ; FORMAT_NCHW, ...

#include "ge/ge_api_types.hpp" // ge::ir_option::SOC_VERSION
#include "ge/ge_ir_build.hpp" // build graph
