...
#include <webnn/webnn_cpp.hpp>
#include <webnn/webnn.hpp>
#ifdef __EMSCRIPTEN__
#include <emscripten.hpp>
#include <emscripten/html5.hpp>
#include <emscripten/html5_webnn.hpp>
#else
#include <webnn/webnn_proc.hpp>
#include <webnn_native/WebnnNative.hpp>
#endif
